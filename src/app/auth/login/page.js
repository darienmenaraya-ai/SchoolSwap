...
export default function Login() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4" style={{ background: 'linear-gradient(135deg, #f0f4ff 0%, #e8eeff 100%)' }}>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 border" style={{ borderColor: '#e2e8ff' }}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl text-sm border-2 outline-none transition-all"
                  style={{
                    borderColor: fieldErrors.email ? '#fca5a5' : '#e5e7eb',
                    color: '#111827',
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-3 rounded-xl text-sm border-2 outline-none transition-all"
                  style={{
          ...
          <div className="mt-6 pt-6 border-t text-center" style={{ borderColor: '#f3f4f6' }}>
            <p className="text-sm" style={{ color: '#6b7280' }}>
              ¿No tenés cuenta?{' '}
              <Link href="/auth/registro" className="font-bold" style={{ color: '#3b4fd8' }}>
                Registrate gratis
              </Link>
            </p>
          </div>
